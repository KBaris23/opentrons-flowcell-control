...
def run(protocol: protocol_api.ProtocolContext):
    ...
    pipette_secondary.transfer(200, reagents['D2'].bottom(2), reagents['B4'].bottom(2), new_tip='always')
    pipette_secondary.transfer(100, reagents['D2'].bottom(2), reagents['B4'].bottom(2), new_tip='always')
    protocol.comment('aptamer solution removed')
    pipette_secondary.transfer(200, reagents['B2'].bottom(2), reagents['D2'].bottom(2), new_tip='always')
    pipette_secondary.transfer(100, reagents['B2'].bottom(2), reagents['D2'].bottom(2), new_tip='always')
    protocol.comment('c6 added')
    protocol.pause('pause for a 1hr wait')
    pipette_secondary.transfer(200, reagents['D2'].bottom(2), reagents['B4'].bottom(2), new_tip='always')
    pipette_secondary.transfer(100, reagents['D2'].bottom(2), reagents['B4'].bottom(2), new_tip='always')
    protocol.comment('aptamer solution removed')
    pipette_secondary.transfer(200, reagents['B3'].bottom(2), reagents['D2'].bottom(2), new_tip='always')
    pipette_secondary.transfer(100, reagents['B3'].bottom(2), reagents['D2'].bottom(2), new_tip='always')
