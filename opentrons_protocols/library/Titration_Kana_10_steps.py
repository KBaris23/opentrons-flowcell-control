...
def run(protocol: protocol_api.ProtocolContext):
    ...
    pipette_primary.transfer(0.975, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('first step done')
    protocol.comment('start titration step 2')
    pipette_primary.transfer(0.95, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 2 done')
    protocol.comment('start titration step 3')
    pipette_primary.transfer(1.851, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 3 done')
    protocol.comment('start titration step 4')
    pipette_primary.transfer(3.604, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 4 done')
    protocol.comment('start titration step 5')
    pipette_primary.transfer(7.017, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 5 done')
    protocol.comment('start titration step 6')
    pipette_primary.transfer(13.667, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 6 done')
    protocol.comment('start titration step 7')
    pipette_secondary.transfer(26.66, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 7 done')
    protocol.comment('start titration step 8')
    pipette_secondary.transfer(52.219, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
    protocol.pause('step 8 done')
    protocol.comment('start titration step 9')
    pipette_secondary.transfer(103.211, stock['D1'].bottom(2), dilute['B2'].bottom(2), new_tip='always')
